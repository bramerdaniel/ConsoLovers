// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ColorExtensions.cs" company="ConsoLovers">
...
namespace ConsoLovers.Console
{
   ...
   public static class ColorExtensions
   {
      ...
      /// <summary>Converts the specified <see cref="Color"/> to it's nearest <see cref="ConsoleColor"/> equivalent.</summary>
