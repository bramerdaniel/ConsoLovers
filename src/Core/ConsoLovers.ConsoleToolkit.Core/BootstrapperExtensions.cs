// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BootstrapperExtensions.cs" company="KUKA Deutschland GmbH">
...
public static class BootstrapperExtensions
{
   ...
   public static IBootstrapper<T> UseApplicationLogic<T, TArguments>([NotNull] this IBootstrapper<T> bootstrapper, [NotNull] Func<TArguments, CancellationToken, Task> applicationLogic)
      where T : class, IApplication where TArguments : class
   {
      ...
      return bootstrapper.ConfigureServices(x => x.AddSingleton<IApplicationLogic>(new DelegateLogic<TArguments>(applicationLogic)));
   }
