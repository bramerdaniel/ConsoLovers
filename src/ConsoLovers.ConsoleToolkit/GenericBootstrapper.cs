...
namespace ConsoLovers.ConsoleToolkit
{
      ...
      where T : class, IApplication
   {
      ...
      ///    <see cref="T:ConsoLovers.ConsoleToolkit.ConsoleWindowHeightAttribute"/>
      /// </summary>
      /// <param name="height">The expected window height.</param>
      /// <returns>The current <see cref="T:ConsoLovers.ConsoleToolkit.IBootstrapper`1"/> for futher configuration</returns>
      ...
      ///    <see cref="T:ConsoLovers.ConsoleToolkit.ConsoleWindowWidthAttribute"/>
      /// </summary>
      ...
      ///    <see cref="T:ConsoLovers.ConsoleToolkit.ConsoleWindowTitleAttribute"/>
      /// </summary>
      ...
      /// <summary>
      ///    Specifies the <see cref="T:ConsoLovers.ConsoleToolkit.CommandLineArguments.IObjectFactory"/> that is used to create the
      ///    <see cref="T:ConsoLovers.ConsoleToolkit.IApplication"/>.
      /// </summary>
